...
public class SnowFlakeFactory {
    ...
    private static volatile com.szcinda.service.SnowFlakeFactory SnowFlakeFactory = null;

    //双重校验锁
    public static com.szcinda.service.SnowFlakeFactory getInstance() {
        if (SnowFlakeFactory == null) {
            synchronized (com.szcinda.service.SnowFlakeFactory.class) {
                if (SnowFlakeFactory == null) {
     ...
     * @return
     */
    public synchronized String nextId(String brStyle) {
        //现存的扩展字段
        long extension = 0L;
        //获取当前时间毫秒数
    ...
    public static void main(String[] args) {
        com.szcinda.service.SnowFlakeFactory snowFlakeFactory = SnowFlakeFactory.getInstance();
        System.out.println(SnowFlakeFactory.nextId("TN"));
    }
}
